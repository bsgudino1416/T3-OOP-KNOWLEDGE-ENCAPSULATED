...
// Asegúrate de importar tu ventana de Login. 
// Si LoginPetshop está en el paquete 'view', descomenta la línea de abajo:
import ec.edu.espe.petshopinventorycontrol.view.LoginPetshop; 
