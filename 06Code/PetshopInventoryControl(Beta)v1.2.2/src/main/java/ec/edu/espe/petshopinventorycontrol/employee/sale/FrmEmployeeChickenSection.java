...
import ec.edu.espe.petshopinventorycontrol.data.ActiveSale;
 ...
 */
public class FrmEmployeeChickenSection extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmEmployeeChickenSection.class.getName());

    /**
     * Creates new form NewJFrame10
     */
    public FrmEmployeeChickenSection() {
        initComponents();
...
// ==== INICIALIZAR ====
    ...
    private void actualizarSubprecioComidaPollo() {
        ...
        double precioLb = switch (seleccionado) {
            case "Balvit crecimiento" ->
                0.38;
            case "Gran ave engorde" ->
                0.38;
    ...
    private void actualizarSubprecioAccesorioPollo() {
    ...
    private void actualizarTotalPollo() {
        ...
        lblTotalChicken.setText("$ " + String.format("%.2f", total));
    }
    ...
    private void guardarSeleccionChicken() {
        ...
        int foodQty = (int) spinnerFoodLb.getValue();
    ...
    private void initComponents() {
        ...
        lblTotalChicken = new javax.swing.JLabel();
        ...
        ComboBoxMake.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Balvit crecimiento", "Gran ave engorde", "Morochillo entero", "Morochillo partido ", "Morochillo vitaminizado", "Moyuelo", "Sal en grano" }));
        ...
        lblChicken.setText("<img.jugueteperro>");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(lblTotalChicken, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(60, 60, 60)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addComponent(lblChicken, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblChicken, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblTotalChicken, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblNoteCat))))
                .addGap(12, 12, 12))
        );
        ...
        jLabel1.setText("MENÚ  (Sección pollo)");
    ...
    private void btnSaveReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveReporteActionPerformed
        ...
        ec.edu.espe.petshopinventorycontrol.data.ActiveSale
                .getSummary()
                .setVisible(true);
        ...
        javax.swing.JOptionPane.showMessageDialog(this,
                "Productos de pollo agregados a la venta");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrmEmployeeChickenSection().setVisible(true));
    }
    ...
    private javax.swing.JLabel lblTotalChicken;
