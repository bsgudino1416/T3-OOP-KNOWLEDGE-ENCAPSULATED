...
public class FrmProduct extends javax.swing.JFrame {
    ...
    private void itmSaveRegisterProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmSaveRegisterProductActionPerformed
        ...
        try {
            ...
            ec.edu.espe.petshopinventorycontrol.controller.StockAlertController alertSystem = new ec.edu.espe.petshopinventorycontrol.controller.StockAlertController();
            alertSystem.verifyAndAlert(name, ((Number) qtyValue).intValue());
