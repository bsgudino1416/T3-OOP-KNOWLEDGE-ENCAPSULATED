...
import ec.edu.espe.petshopinventorycontrol.controller.EmployeeSummaryView;

import ec.edu.espe.petshopinventorycontrol.controller.TableToMongo;
import java.io.File;
 ...
 */
public class FrmEmployeeSummary extends javax.swing.JFrame implements EmployeeSummaryView {
     ...
     */
    public FrmEmployeeSummary() {
        initComponents();
        ActiveSale.setSummary((EmployeeSummaryView) this);
    }
    ...
    private void btnBackMenuSaleActionPerformed() {
        ec.edu.espe.petshopinventorycontrol.view.FrmEmployeeSale
                .getInstance()
                .setVisible(true);
