...
public final class SecretKeyProvider {
    ...
    public SecretKey getAesKey() {
        ...
        // Fallback DEV (para que no se te caiga en ejecución). En producción NO usar esto.
        ...
        if (raw.length != 32) {
            throw new IllegalStateException("PETSHOP_SECRET_KEY_B64 must decode to 32 bytes (AES-256).");
        }
