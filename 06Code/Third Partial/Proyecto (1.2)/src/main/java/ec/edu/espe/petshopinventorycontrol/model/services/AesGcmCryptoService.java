...
public final class AesGcmCryptoService implements CryptoService {
    ...
    public String encryptToBase64(String plainText) {
        if (plainText == null) throw new IllegalArgumentException("El texto no puede ser nulo");
        try {
    ...
    public String decryptFromBase64(String base64CipherText) {
        if (base64CipherText == null) throw new IllegalArgumentException("El cifrado no puede ser nulo");
        try {
