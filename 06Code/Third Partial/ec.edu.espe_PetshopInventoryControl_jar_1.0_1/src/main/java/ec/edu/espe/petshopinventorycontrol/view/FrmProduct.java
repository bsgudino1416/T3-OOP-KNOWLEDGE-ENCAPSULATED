...
//import ec.edu.espe.petshopinventorycontrol.view.FrmGraphicProduct;
...
//        }
    ...
    private void initComponents() {
        ...
        btnBackProduct.setText("Regresar");
        ...
        itmGraphicProduct.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itmGraphicProductActionPerformed(evt);
            }
        });
    ...
    private void itmSaveRegisterProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmSaveRegisterProductActionPerformed
        ...
        String type = (String) cmbTypeProduct.getSelectedItem();
        String animal = (String) cmbTypeAnimal.getSelectedItem();  
    ...
    private void itmGraphicProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmGraphicProductActionPerformed

        FrmGraphicProduct graphicProduct = new FrmGraphicProduct();
        graphicProduct.setVisible(true);
        this.dispose();
        // TODO add your handling code here:
    }//GEN-LAST:event_itmGraphicProductActionPerformed
