...
import ec.edu.espe.petshopinventorycontrol.employee.sale.ActiveSale;
...
// ==== INICIALIZAR ====
    ...
    double precioLb = switch (seleccionado) {
        case "Balvit crecimiento" -> 0.38;
        case "Gran ave engorde" -> 0.38;
...
private void guardarSeleccionChicken() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENÚ EMPLEADO (Sección pollo)");
